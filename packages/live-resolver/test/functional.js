...
parallel('functional', () => {
  ...
  testUrl(
    '/q/java/org.springframework.boot.actuate.audit.listener.AbstractAuditListener',
    'https://docs.spring.io/spring-boot/docs/1.5.8.RELEASE/api/org/springframework/boot/actuate/audit/listener/AbstractAuditListener.html',
  );
});
